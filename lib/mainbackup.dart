...
//     await _setComposerCustom(_colorLevel, _filterLevel, _filtername);
//   }

//   Future<void> _setComposerCustom(
//       double colorValue, double filterValue, String filterName) async {
//     await _rtcEngine.enableExtension(
//         provider: "FaceUnity", extension: "Effect", enable: true);
...
//                 //   TextButton(
//                 //     onPressed: () {},
//                 //     child: const CircleAvatar(child: Text('2')),
//                 //   ),
//                 //   TextButton(
//                 //     onPressed: () {},
//                 //     child: const CircleAvatar(child: Text('3')),
//                 //   ),
//                 //   TextButton(
//                 //     onPressed: () {},
...
//                   TextButton(
//                     onPressed: () {
//                       _setComposerCustom(_colorLevel, _filterLevel, '');
//                     },
//                     child: Container(
//                       padding: const EdgeInsets.all(10.0),
//                       color: Colors.blue,
